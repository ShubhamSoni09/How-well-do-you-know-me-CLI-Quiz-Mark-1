...
function main(){
  console.log(colorPattern("red","HOW WELL DO YOU KNOW Shubham QUIZ 2021 EDITION!\n\n" ))
...
console.log("Check out the current High scores: \n")
 ...
 var arrays = ["Soham: 70 ","Shivam: 70", "Moksh: 70","Mihir: 70"]
...
var twitter = chalk.blue.bold.underline("https://twitter.com/imshubhxm")
